...
def generate_article(client, topic, seo_context):
    ...
    请根据提供的主题，结合SEO优化原则（自然融入长尾词、吸引点击的标题、清晰的结构），写一篇高质量的行业动态/技术干货文章。
    ...
    {{
      ...
      "content": "文章正文（中文）。使用 Markdown 格式排版，包含 h2 标题 (##)、段落、加粗、甚至引言(> )，字数 800-1200 字左右，内容要有深度、干货满满，自然融入相关关键词。",
      "content_en": "文章正文（英文）。对中文正文的精准专业翻译，同样保留 Markdown 排版。",
